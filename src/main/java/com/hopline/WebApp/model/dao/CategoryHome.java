 ...
 * @see com.hopline.WebApp.model.dao.Category
...
public class CategoryHome {
	...
	public Category findById(java.lang.Integer id) {
		...
		try {
			Category instance = (Category) sessionFactory.getCurrentSession()
					.get("com.hopline.WebApp.model.dao.Category", id);
			if (instance == null) {
	...
	public List findByExample(Category instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.hopline.WebApp.model.dao.Category")
